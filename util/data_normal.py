...
from util.sampling import mnist_iid, mnist_iid_normal, mnist_noniid, cifar_iid, mnist_noniid_normal, minmax_dataset, \
    fmnist_iid_normal, fmnist_noniid_normal
import numpy as np
import random
...
def load_data(args):
    ...
    if args.dataset == 'mnist':
        ...
        dataset_train.data, dataset_train.targets = dataset_train.data[train_index].float() / 255., \
        dataset_train.targets[train_index]
        dataset_test.data, dataset_test.targets = dataset_test.data[test_index].float() / 255., dataset_test.targets[
            test_index]
